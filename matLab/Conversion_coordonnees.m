function [Coord] = Conversion_coordonnees(LON,LAT,echelle_x,echelle_y,lon_min,lat_min)
%Le but va etre ici de convertir un nombre donné sous le format
%degré/minute/seconde en une latitude et une longitude dans un repère
%cartésien
...
Coord(i,1) = (LONGITUDE(i) - lon_min) * echelle_x;
Coord(i,2) = (LATITUDE(i) - lat_min) * echelle_y;
